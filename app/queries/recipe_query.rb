...
class RecipeQuery
  ...
  #
  # @return [ActiveRecord::Relation] a scope containing only carb free recipes
  def carb_free
  ...
  #
  # @return [ActiveRecord::Relation] a scope containing only gluten-free recipes
  def gluten_free
  ...
  #
  # @return [ActiveRecord::Relation] a scope containing only kosher recipes
  def kosher
  ...
  #
  # @return [ActiveRecord::Relation] a scope containing only paleo recipes
  def paleo
  ...
  #
  # @return [ActiveRecord::Relation] a scope containing only vegan recipes
  def vegan
  ...
  #
  # @return [ActiveRecord::Relation] a scope containing only vegetarian recipes
  def vegetarian
  ...
  #
  # @return [ActiveRecord::Relation] a scope containing only the ingredients in the array recipes
